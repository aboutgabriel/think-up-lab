...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/[0.97] backdrop-blur-md border-b border-border">
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-background/[0.97] backdrop-blur-md border-b border-border py-4">
